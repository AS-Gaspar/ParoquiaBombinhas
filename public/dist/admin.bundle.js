...
function fetchAndRenderEvents() {
  return _fetchAndRenderEvents.apply(this, arguments);
}
function _fetchAndRenderEvents() {
  _fetchAndRenderEvents = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response, fetchedEvents;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 13:
          ...
          console.error("Erro ao buscar eventos:", _context2.t0);
...
document.getElementById("eventForm").addEventListener("submit", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var localInput, dataInput, horaInput, nomeInput, descriptionInput, eventData, response, errorData, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          localInput = document.getElementById("eventLocal");
          dataInput = document.getElementById("eventDate");
          horaInput = document.getElementById("eventHour");
          nomeInput = document.getElementById("eventName");
        ...
        case 25:
          ...
          console.error("Erro ao adicionar evento:", _context.t0);
          alert("Falha ao adicionar evento: ".concat(_context.t0.message));
        case 29:
        case "end":
...
(0,flatpickr__WEBPACK_IMPORTED_MODULE_0__["default"])("#eventDate", {
  dateFormat: "d/m/Y",
  minDate: "today",
  enableTime: false
});
var hourInput = document.getElementById("eventHour");
...
function renderEventos() {
  var adminEventList = document.getElementById("adminEventList");
  if (!adminEventList) {
  ...
  eventos.sort(function (a, b) {
    try {
      var dateA = a.data ? (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parse)(a.data, "dd/MM/yyyy", new Date()) : new Date(0);
      var dateB = b.data ? (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parse)(b.data, "dd/mm/yyyy", new Date()) : new Date(0);
      return dateA - dateB;
    } catch (e) {
  ...
  eventos.forEach(function (evento, index) {
    if (!evento || _typeof(evento) !== 'object') {
    ...
    var local = evento.local || 'N/A';
    var data = evento.data || 'N/A';
    var hora = evento.hora || 'N/A';
    var nome = evento.nome || 'N/A';
    var description = evento.description || 'N/A';
    var descriptionHtml = description ? ", <strong>Descri\xE7\xE3o:</strong> ".concat(description) : '';
    li.innerHTML = "<span>\n    <strong>Local:</strong> ".concat(local, ",\n    <strong>Data:</strong> ").concat(data, ",\n    <strong>Hora:</strong> ").concat(hora, ",\n    <strong>Nome:</strong> ").concat(nome).concat(descriptionHtml, "\n    </span>\n    <span>\n      <button class=\"btn btn-sm btn-warning m-2\" onclick=\"window.location.href='/views/edit-event.html?id=").concat(evento.id, "'\">Editar</button>\n      <button class=\"btn btn-sm btn-danger\" data-remove=\"").concat(evento.id, "\">Remover</button>\n    </span>");
    adminEventList.appendChild(li);
  });
}
function removerEvento(_x2) {
  return _removerEvento.apply(this, arguments);
}
function _removerEvento() {
  _removerEvento = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    var response, errorMessage, errorData;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return fetch("/admin/events/".concat(id), {
            method: 'DELETE'
          });
        case 3:
        ...
        case 21:
          ...
          console.error('Erro ao remover evento:', _context3.t1);
          alert("Falha ao remover evento: ".concat(_context3.t1.message));
        case 25:
        case "end":
          return _context3.stop();
      }
    }, _callee3, null, [[0, 21], [6, 13]]);
  }));
  return _removerEvento.apply(this, arguments);
}
document.addEventListener('DOMContentLoaded', function () {
  var adminEventList = document.getElementById("adminEventList");
  if (adminEventList) {
    adminEventList.addEventListener('click', function (event) {
      if (event.target.matches('button[data-remove]')) {
        var eventId = event.target.getAttribute('data-remove');
